          ...
          <ul className={classes.service_list}>
            <li className={classes.service_item}>
              <div className={classes.service_unit}>
                <div className={`${classes.service_tit} ${classes.service_tit_duo}`} />
                <p className={classes.service_txt}>品类齐全，轻松购物</p>
              </div>
            </li>
            <li className={classes.service_item}>
              <div className={classes.service_unit}>
                <div className={`${classes.service_tit} ${classes.service_tit_kuai}`} />
                <p className={classes.service_txt}>多仓直发，急速配送</p>
              </div>
            </li>
            <li className={classes.service_item}>
              <div className={classes.service_unit}>
                <div className={`${classes.service_tit} ${classes.service_tit_hao}`} />
                <p className={classes.service_txt}>正品行货，精致服务</p>
              </div>
            </li>
            <li className={classes.service_item}>
              <div className={classes.service_unit}>
                <div className={`${classes.service_tit} ${classes.service_tit_sheng}`} />
